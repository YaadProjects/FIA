...
public class PlayServicesHelper {
    ...
    private static final String PROJECT_NUMBER          = "635836970117";//"595564954155";//
...
//        }
    ...
    private String getRegistrationId() {
        ...
        int currentVersion = FiaApplication.getApp().getAppVersion();
    ...
    private void storeRegistrationId(String regId) {
        final SharedPreferences prefs = getGCMPreferences();
        int appVersion = FiaApplication.getApp().getAppVersion();
